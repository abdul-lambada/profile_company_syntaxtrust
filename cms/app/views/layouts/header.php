<!DOCTYPE html>
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="<?php echo ASSETS_PATH; ?>/" data-template="vertical-menu-template-free">
<head>
    <meta charset="utf-8" />
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="<?php echo URLROOT; ?>" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">SIKES CMS</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    <!-- Dashboard -->
                    <li class="menu-item <?php echo (!isset($_GET['url']) || $_GET['url'] == 'Dashboard') ? 'active' : ''; ?>">
                        <a href="<?php echo URLROOT; ?>" class="menu-link">
                    ...
                    <li class="menu-header small text-uppercase">
                        <span class="menu-header-text">Konten Landing Page</span>
                    </li>

                    <li class="menu-item <?php echo (isset($_GET['url']) && strpos($_GET['url'], 'hero') !== false) ? 'active' : ''; ?>">
                        <a href="<?php echo URLROOT; ?>/hero" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-laptop"></i>
                            <div data-i18n="Hero">Hero Section</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item <?php echo (isset($_GET['url']) && strpos($_GET['url'], 'how_it_works') !== false) ? 'active' : ''; ?>">
                        <a href="<?php echo URLROOT; ?>/how_it_works" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-list-ol"></i>
                            <div data-i18n="HowItWorks">Cara Kerja</div>
                        </a>
                    </li>
