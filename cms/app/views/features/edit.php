    ...
    <div class="col-xl">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit Fitur Unggulan</h5>
                <small class="text-muted float-end">Features CMS</small>
            </div>
            <div class="card-body">
                <form action="<?php echo URLROOT; ?>/features/edit/<?php echo $data['id']; ?>" method="POST">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control font-monospace" id="ikon_svg_path" name="ikon_svg_path" rows="5" required><?php echo $data['ikon_svg_path']; ?></textarea>
                         <div class="form-text">Masukkan atribut <code>d="..."</code> dari tag SVG Path.</div>
                    </div>
