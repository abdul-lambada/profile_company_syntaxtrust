<!DOCTYPE html>
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="<?php echo ASSETS_PATH; ?>/" data-template="vertical-menu-template-free">
<head>
    <meta charset="utf-8" />
    ...
    <!-- Page CSS -->
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>/vendor/css/pages/page-auth.css" />
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="<?php echo URLROOT; ?>" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">SIKES CMS</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        ...
                        <form id="formAuthentication" class="mb-3" action="<?php echo URLROOT; ?>/login" method="POST">
                            <div class="mb-3">
                                <label for="username" class="form-label">Username</label>
                                <input type="text" class="form-control <?php echo (!empty($data['username_err'])) ? 'is-invalid' : ''; ?>" id="username" name="username" placeholder="Masukkan username" value="<?php echo $data['username']; ?>" autofocus />
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" class="form-control <?php echo (!empty($data['password_err'])) ? 'is-invalid' : ''; ?>" name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" value="<?php echo $data['password']; ?>" />
